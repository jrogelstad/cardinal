...
(function (datasource) {
    ...
    /**
      Post a series of receivables and create journals.

      @param {Object} [payload] Payload.
      @param {Object} [payload.client] Database client.
      @param {Object} [payload.data] Receivable data
      @param {Array} [payload.data.ids] Receivable ids to post. Default = all.
      @param {String} [payload.profile.feather] Receivable feather type. "Invoice" or "CreditMemo"
    ...
    */
    function doPostReceivables(obj) {
    ...
    datasource.registerFunction("POST", "postReceivables", doPostReceivables);

    /**
      Post an receivable and create journal.

      @param {Object} [payload] Payload.
      @param {Object} [payload.client] Database client.
      @param {Object} [payload.data] Receivable data
      @param {Object} [payload.data.id] Receivable id to post. Required
      @param {Object} [payload.data.date] Post date. Default today.
    */
    function doPostReceivable(obj) {
        return new Promise(function (resolve, reject) {
            ...
            doPostReceivables(obj)
                .then(resolve)
                .catch(reject);
        });
    }

    datasource.registerFunction("POST", "postReceivable", doPostReceivable);
